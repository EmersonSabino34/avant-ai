      ...
      <div className="w-1/5 h-1/2 flex flex-col items-center gap-4">
        ...
        <div className="bg-white rounded-md h-auto flex flex-col items-center border-2">
          ...
          <form className=" flex flex-col w-80 m-4 gap-1">
            ...
            <input type="email" name="email" className="w-80 border-2 p-2 rounded-md" />
          </form>

          <Link href="/">
            <button className="bg-blue-700 w-80 mb-3 p-2 text-white text-sm rounded-md font-semibold cursor-pointer">Redefinir senha</button>
          </Link>
